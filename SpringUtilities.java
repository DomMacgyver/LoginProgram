...
public class SpringUtilities 
{
	 public static void printSizes(Component c) {
	     ...
	     * @param yPad y padding between cells
	     */
	    public static SpringLayout makeCompactGrid(Container parent,int rows, int cols,int initialX, int initialY,int xPad, int yPad) {
	        SpringLayout layout;
	        try {
	            layout = (SpringLayout)parent.getLayout();
	        } catch (ClassCastException exc) {
	        ...
	        for (int r = 0; r < rows; r++) {
	            ...
	            //y = Spring.constant(100);
	        }

	        //Set the parent's size.
	        SpringLayout.Constraints pCons = layout.getConstraints(parent);
	        layout.putConstraint(SpringLayout.SOUTH,parent,180,SpringLayout.NORTH,parent);
	        layout.putConstraint(SpringLayout.EAST,parent,400,SpringLayout.WEST,parent);
